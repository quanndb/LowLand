...
public class ProductImageService {
    ...
    public ProductImage createProductImage(MultipartFile file, String productId) throws IOException {
        Map<?,?> res = _service.upload(file);
        CloudResponse cloudResponse = cloudImageMapper.toCloudResponse(res);
        return _repo.save(ProductImage.builder()
                .productId(productId)
    ...
    public boolean deleteProductImage(String id) throws IOException {
        ProductImage productImage = _repo.findById(id)
